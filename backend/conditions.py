conditions = {
            ...
            "(not Computer.R) and Computer.T(0)": ["Computer.AR <<= Computer.PC","Computer.last_instructions = ['AR <- PC']"],
            ...
            "Computer.R and Computer.T(0)": ["Computer.AR.reset()", "Computer.TR <<= Computer.PC",
                                             "Computer.last_instructions = ['AR <- 0', 'TR <- PC']"],
            ...
            "Computer.R and Computer.T(2)": ["Computer.IEN = False", "Computer.PC.increment()", "Computer.R = False", "Computer.SC = -1",
            ...
            "Computer.D(0) and Computer.T(5)": ["Computer.AC &= Computer.DR", "Computer.SC = -1"],
            "Computer.D(1) and Computer.T(4)": ["Computer.DR <<= Computer.Memory[Computer.decode(Computer.AR.data)]"],
            "Computer.D(1) and Computer.T(5)": ["Computer.AC,Computer.E = Computer.AC + Computer.DR", "Computer.SC = -1"],
            "Computer.D(2) and Computer.T(4)": ["Computer.DR <<= Computer.Memory[Computer.decode(Computer.AR.data)]"],
            "Computer.D(2) and Computer.T(5)": ["Computer.AC <<= Computer.DR", "Computer.SC = -1"],
            "Computer.D(3) and Computer.T(4)": ["Computer.Memory[Computer.decode(Computer.AR.data)] <<= Computer.AC", "Computer.SC = -1"],
            "Computer.D(4) and Computer.T(4)": ["Computer.PC <<= Computer.AR", "Computer.SC = -1"],
            "Computer.D(5) and Computer.T(4)": ["Computer.Memory[Computer.decode(Computer.AR.data)] <<= Computer.PC", "Computer.AR.increment()"],
            "Computer.D(5) and Computer.T(5)": ["Computer.PC <<= Computer.AR", "Computer.SC = -1"],
            ...
            "Computer.D(6) and Computer.T(6)": ["Computer.Memory[Computer.decode(Computer.AR.data)] <<= Computer.DR","Computer.SC = -1","if (int(Computer.DR)==0): Computer.PC.increment()"],
